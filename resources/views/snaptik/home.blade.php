...
<li class="lang-item" data-id="en"><a class="dropdown-item" href="{{ url('/') }}/en/">English</a></li>
<li class="lang-item" data-id="ID"><a class="dropdown-item" href="{{ url('/') }}/ID/">Bahasa Indonesia</a></li>
<li class="lang-item" data-id="vn"><a class="dropdown-item" href="{{ url('/') }}/vn/">Ting Việt</a></li>
<li class="lang-item" data-id="ms"><a class="dropdown-item" href="{{ url('/') }}/ms/">Bahasa Malaysia</a></li>
<li class="lang-item" data-id="jv"><a class="dropdown-item" href="{{ url('/') }}/jv/">Basa Jawa</a></li>
<li class="lang-item" data-id="cs"><a class="dropdown-item" href="{{ url('/') }}/cs/">Čeština</a></li>
<li class="lang-item" data-id="es"><a class="dropdown-item" href="{{ url('/') }}/es/">Español</a></li>
<li class="lang-item" data-id="fr"><a class="dropdown-item" href="{{ url('/') }}/fr/">Français</a></li>
<li class="lang-item" data-id="de"><a class="dropdown-item" href="{{ url('/') }}/de/">German</a></li>
<li class="lang-item" data-id="it"><a class="dropdown-item" href="{{ url('/') }}/it/">Italian</a></li>
<li class="lang-item" data-id="hu"><a class="dropdown-item" href="{{ url('/') }}/hu/">Magyar</a></li>
<li class="lang-item" data-id="nl"><a class="dropdown-item" href="{{ url('/') }}/nl/">Nederlands</a></li>
<li class="lang-item" data-id="pl"><a class="dropdown-item" href="{{ url('/') }}/pl/">Polish</a></li>
<li class="lang-item" data-id="pt"><a class="dropdown-item" href="{{ url('/') }}/pt/">Português</a></li>
<li class="lang-item" data-id="ro"><a class="dropdown-item" href="{{ url('/') }}/ro/">Română</a></li>
<li class="lang-item" data-id="th"><a class="dropdown-item" href="{{ url('/') }}/th/">Thailand</a></li>
<li class="lang-item" data-id="tr"><a class="dropdown-item" href="{{ url('/') }}/tr/">Turkish (Turkey)</a></li>
<li class="lang-item" data-id="el"><a class="dropdown-item" href="{{ url('/') }}/el/">Εληνκά</a></li>
<li class="lang-item" data-id="uk"><a class="dropdown-item" href="{{ url('/') }}/uk/">країнска мо́в</a></li>
<li class="lang-item" data-id="ru"><a class="dropdown-item" href="{{ url('/') }}/ru/">Русски</a></li>
...
<ul class="z-tabs">
<li><a href="{{ url('/') }}">TikTok Video</a></li>
<li><a href="{{ url('/') }}/download-tiktok-mp3/">MP3</a></li>
<li><a href="{{ url('/') }}/download-tiktok-slide/">Slideshow</a></li>
<li><a href="{{ url('/') }}/download-story-tiktok/">Story</a></li>
<li><a href="{{ url('/') }}/douyin-downloader/">DouYin</a></li>
</ul>
...
<div class="accordion-content" itemprop="acceptedAnswer" itemscope itemtype="https://schema.org/Answer">
<div class="pt-3" itemprop="text">
Because of Apple's privacy policy, from IOS 12 and IPAD OS 12 and below you cannot download any videos, music or movies to your iPhone. You should update to the latest iOS to be able to use Safari to download Tiktok videos From SnapTik. If you still can't download please follow the tutorial <a id="click_hd_iphone" target="_blank" rel="nofollow" href="{{ url('/') }}/landing/how-to-download-on-iphone/">How to download tiktok videos without watermark on iPhone</a> </div>
</div>
</div>
<div class="accordion-item" itemprop="mainEntity" itemscope itemtype="https://schema.org/Question">
<button class="btn accordion-button">
...
<h3>Legal</h3>
<ul>
<li><a href="{{ url('/') }}/landing/terms-of-service/">Terms of Service</a></li>
<li><a href="{{ url('/') }}/landing/privacy-policy/">Privacy Policy</a></li>
</ul>
</div>
<div>
<h3>Tools</h3>
<ul>
<li><a href="{{ url('/') }}/douyin-downloader/">Download Video Douyin</a></li>
<li><a href="{{ url('/') }}/download-tiktok-slide/">Download TikTok Slideshow</a></li>
<li><a href="{{ url('/') }}/download-story-tiktok/">Download TikTok Story</a></li>
</ul>
</div>
</div>
</div>
...
<div>&copy; 2024 (v1.1) <a href="{{ url('/') }}" title="SnapTik">SnapTik</a>. All rights reserved.</div>
</div>
</div>
</footer>
